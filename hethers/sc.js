...
const aliceId = AccountId.fromString("0.0.48941756");
...
const contractadd = '0000000000000000000000000000000002ea6ee8';
const ABI =[
	{
		"inputs": [],
...
async function main() {
	...
	console.log(`\n- INTERACT WITH THE DEPLOYED CONTRACT`);
		...
		console.log(await contractWithSigner.name({gasLimit: 50000}))
		console.log(await contractWithSigner.symbol({gasLimit: 50000}))
		console.log(await contractWithSigner.owner({gasLimit: 50000}))
		console.log(await contractWithSigner.balanceOf(wallet.address , 1,{gasLimit: 30000}))
		

  console.log(`\n- TRANSFER TO ALICE WALLET ALEX`);
//   const amount = hethers.utils.parseUnits('1');
//   const tx = await contractWithSigner.mint('0x0000000000000000000000000000000002eacabc','1',{gasLimit: 50000});
//   console.log(tx)
